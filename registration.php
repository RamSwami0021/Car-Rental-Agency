    ...
    if (($username != null) && ($password != null)) {
        ...
        if ($num > 0) {
            ...
            if ($password == $passwordConfirm) {
                ...
                $sql = "INSERT INTO `users` (`username`, `email`,`usertype`, `password`) VALUES ('$username','$email', '$usertype', '$hasPass')";
    ...
    <div class="header_section">
        <div class="contact_section layout_padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="contact_taital" style="color: #fe5b29;">Customer Registration</h1>
                    </div>
                </div>
            </div>
            <div class="container">
